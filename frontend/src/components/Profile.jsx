                ...
                <div className="flex items-center justify-between bg-gray-900/20 backdrop-blur-xl rounded-2xl p-6 border border-gray-700/30">
                    ...
                    <div className="flex items-center space-x-4">
                        <motion.button
                            ...
                            className="flex items-center space-x-2 px-4 py-2 bg-red-600/20 hover:bg-red-600/30 text-red-400 rounded-xl transition-all duration-300 border border-red-600/30"
                        ...
                        {editOfferedSkills && (
                            <div className="flex space-x-3">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 bg-gray-800/20 backdrop-blur-sm text-white rounded-xl border border-gray-600/30 focus:outline-none focus:ring-2 focus:ring-yellow-500/50 focus:border-yellow-500/50 transition-all duration-300 placeholder-gray-500"
                                    onKeyPress={(e) => {
                                        if (e.key === 'Enter') {
                                            e.preventDefault();
                                            handleAddSkill(newOfferedSkill, 'OFFERED');
                                        }
                                    }}
                                />
                                <motion.button
                                    ...
                                    className="px-4 py-3 bg-yellow-600/20 hover:bg-yellow-600/30 text-yellow-400 rounded-xl transition-all duration-300 border border-yellow-600/30"
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                >
                        ...
                        {editWantedSkills && (
                            <div className="flex space-x-3">
                                <input
                                    ...
                                    className="flex-1 px-4 py-3 bg-gray-800/20 backdrop-blur-sm text-white rounded-xl border border-gray-600/30 focus:outline-none focus:ring-2 focus:ring-emerald-500/50 focus:border-emerald-500/50 transition-all duration-300 placeholder-gray-500"
                                    onKeyPress={(e) => {
                                        if (e.key === 'Enter') {
                                            e.preventDefault();
                                            handleAddSkill(newWantedSkill, 'WANTED');
                                        }
                                    }}
                                />
                                <motion.button
                                    ...
                                    className="px-4 py-3 bg-emerald-600/20 hover:bg-emerald-600/30 text-emerald-400 rounded-xl transition-all duration-300 border border-emerald-600/30"
                                    whileHover={{ scale: 1.05 }}
                                    whileTap={{ scale: 0.95 }}
                                >
                                    <Plus className="w-5 h-5" />
